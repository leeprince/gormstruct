...
const _gen_test_db_dns = "host=47.116.189.118 user=firework_ai_user password=4fireworkAI@Yzy dbname=firework_ai port=5432 sslmode=disable TimeZone=Asia/Shanghai"
...
func InitializeDB() {
	_gen_test_once.Do(func() {
		var err error
		_gen_test_db, err = gorm.Open(postgres.Open(_gen_test_db_dns), &gorm.Config{})
...
func Test_WithContext(t *testing.T) {
	...
	for _, ctx := range []context.Context{
		qCtx.UserInfo.UnderlyingDB().Statement.Context,
	} {
